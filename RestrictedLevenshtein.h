...
extern float RestrictedLevenshtein(int FirstCharacter, unsigned char *pattern1, unsigned char *pattern2, int length1, int length2, Limits Limit , Path *path, int *SlopeToMinimumPath) ;
...
extern float bb(float distance2,int length1, int length2, unsigned char *pattern1, unsigned char *pattern2, Path *BestPath, Path *path, int bb_type, int *cyc, unsigned int * rotation, unsigned int * distance, int *SlopeToMinimumPath) ;
